...
public class PictureUtils {
	...
	/**
	 * Method that creates the image file
	 * @return the image
	 * @throws IOException
	 */
	...
	/**
	 * Method that calculate the sample size
	 * @param options : options to calculate
	 * @param reqWidth : the width
	 * @param reqHeight : the height
