...
public class Anchor {
    ...
    public static final Coordinates POSITION_0X00B8 = new Coordinates(5f, 3f, 0f);
    public static final Coordinates POSITION_0X00C7 = new Coordinates(-4f, 2f, 0f);
    public static final Coordinates POSITION_0X00C4 = new Coordinates(8f, 11f, 0f);
    public static final Coordinates POSITION_0X00B9 = new Coordinates(8f, -1f, 0f);
    public static final Coordinates POSITION_0X00CA = new Coordinates(-5f, 0f, 0f);
    public static final Coordinates POSITION_0X00DF = new Coordinates(-6f, -1f, 0f);
    public static final Coordinates POSITION_0X00BB = new Coordinates(-6f, 11f, 0f);
