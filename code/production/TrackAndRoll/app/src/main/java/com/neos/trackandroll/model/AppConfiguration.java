...
public class AppConfiguration {
    ...
    /**
     * Setter of the trackAndRollSensorList
     * @param trackAndRollSensorList : the trackAndRollSensorList
     */
    public void setTrackAndRollSensorList(ArrayList<TrackAndRollSensor> trackAndRollSensorList) {
