...
public class ActionRelaunchWatchdogForArmband extends AbstractActionForBrain {
    ...
    private class TimerWatchdogArmband extends TimerTask {
        ...
        public void run() {
            ...
            DataStore.getInstance().getHeartBeatSensorMap().get(armbandId).setState(
                    ArmbandSensor.ArmbandSensorState.DISCONNECTED
            );
