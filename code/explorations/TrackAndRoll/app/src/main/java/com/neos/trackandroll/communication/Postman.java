...
public class Postman {
     ...
     */
    public Postman(Communication communication) {
        this.communication = communication;
        stateSocket = CONNEXION;
        new SetUpConnexion().execute();
    }
    ...
    private class SetUpConnexion extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            try {
                ...
                LogUtils.e(LogUtils.DEBUG_TAG,"SocketTimeoutException : BeagleBone not found",ste);

            } catch (ConnectException connectException) {

                // appears when the network is not available (wifi may be disabled)
                LogUtils.e(LogUtils.DEBUG_TAG,"ConnectException : Beaglebone not found / Wifi interface disabled",connectException);
