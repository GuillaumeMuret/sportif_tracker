...
import com.neos.trackandroll.cervo.controller.distribution.maestro.ActionFindTagPosition;
import com.neos.trackandroll.cervo.controller.distribution.maestro.ActionLaunchTimerCheckMaestroConnection;
import com.neos.trackandroll.cervo.controller.distribution.maestro.ActionSendAllTagsForMaestro;
...
public final class Brain implements ICommunicationState {
     ...
     */
    private HashMap<String, IActionForBrain> actionsForBrain;
    ...
    private Brain() {
        ...
        this.actionsForBrain.put(ActionForBrain.ACTION_SEND_ALL_TAGS_FOR_MAESTRO,
                new ActionSendAllTagsForMaestro(this));
