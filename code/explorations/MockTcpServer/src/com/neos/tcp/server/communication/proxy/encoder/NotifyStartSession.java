...
public class NotifyStartSession extends AbstractEncoder {

    /**
     * Main constructor of the proxy client
     * @param proxyClient : the proxy client
     */
    public NotifyStartSession(ProxyClient proxyClient) {
        super(proxyClient);
    }
    ...
    public void sendMessage() {
        ...
        Message message = new Message(ProcessOut.PROXY_CLIENT_NOTIFY_START_SESSION.process, params);
        Gson gson = new Gson();
