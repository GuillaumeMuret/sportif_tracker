...
import com.neos.tcp.server.communication.proxy.encoder.NotifyStartSession;
import com.neos.tcp.server.controller.Brain;

public class StartSaving implements ICommandFromClient {
    ...
    public void convertMessageAndCallManager(String params, Brain brain) {
        ...
        ((NotifyStartSession) brain.getCommunication().getProxyClient().getEncoders().get(ProcessOut.PROXY_CLIENT_NOTIFY_START_SESSION)).sendMessage();
